    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res) {
                ...
                let referents = res.referents;
                let secondaryReferent = res.secondary_referent;

                let last = document.querySelector("#offcanvasEtp")
                if (last) {
                    last.remove();
                }

                let principal_referent =
                    `
                    <li class="pt-3 pb-0 sm:pt-4">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                ${referents[0].photo ? `<img class="w-10 h-10 rounded-full" src="https://formafusionmg.ams3.cdn.digitaloceanspaces.com/formafusionmg/img/referents/${referents[0].photo}" alt="${referents[0].name ? referents[0].name : ''}">`
                        : `<div class="w-10 h-10 rounded-full text-gray-500 font-bold text-2xl text-center bg-gray-200 relative">
                                            <p class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">${referents[0].name ? referents[0].name.charAt(0) : 'I'}</p>        
                                        </div>`}
                            </div>
                            <div class="flex-1 min-w-0 ms-4 ">
                                <p class="text-sm font-medium text-gray-900 truncate">
                                <i class="fa-solid fa-user text-sm"></i>
                                    ${referents[0].name ? referents[0].name : ''} ${referents[0].firstName ? referents[0].firstName : ''} (${referents[0].fonction ? referents[0].fonction : 'fonction non renseignée'})
                                </p>
                                <p class="text-sm text-gray-500 truncate">
                                <i class="fa-solid fa-envelope text-sm"></i>
                                    ${referents[0].email ? referents[0].email : 'non renseigné'}                       
                                </p>
                                <p class="text-sm text-gray-500 truncate">
                                <i class="fa-solid fa-phone text-sm"></i>
                                    ${referents[0].customerPhone ? referents[0].customerPhone : 'non renseigné'}                      
                                </p>
                            </div>
                        </div>
                    </li>
                ...
                secondaryReferent.forEach((referent, i) => {
                    if (secondaryReferent.length > 0) {
                        other_referent +=
                            `<li class="pt-3 pb-0 sm:pt-4">
                            <div class="flex items-center">
                                       <div class="flex-shrink-0">
                                ...
                                <div class="flex-1 min-w-0 ms-4 ">
                                    <p class="text-sm font-medium text-gray-900 truncate">
                                    <i class="fa-solid fa-user text-sm"></i>
                                        ${referent.name ? referent.name : ''} ${referent.firstName ? referent.firstName : ''} (${referent.fonction ? referent.fonction : 'fonction non renseignée'})
                                    </p>
                                    <p class="text-sm text-gray-500 truncate">
                                    <i class="fa-solid fa-envelope text-sm"></i>
                                        ${referent.email ? referent.email : 'non renseigné'}                         
                                    </p>
                                    <p class="text-sm text-gray-500 truncate">
                                    <i class="fa-solid fa-phone text-sm"></i>
                                        ${referent.phone ? referent.phone : 'non renseigné'}                         
                                    </p>
                                </div>
                            </div>
                        </li>
                ...
                body.html('');
                body.append(`<div class="offcanvas offcanvas-end !w-[65rem] overflow-y-auto" tabindex="-1" id="offcanvasEtp"
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <div class="w-full p-3">
                                <div class="w-full inline-flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col justify-start gap-y-2 w-full">
                                        ...
                                        <p class="text-base text-gray-500 text-left">${customer.customer_slogan ? customer.customer_slogan : "--"}</p>
                                        <p class="text-base text-gray-500 text-left">Site web: ${customer.siteWeb ? customer.siteWeb : "--"}</p>
                                        <p class="text-base text-gray-500 text-left">Telephone: ${customer.customerPhone ? customer.customerPhone : "--"}</p>
                                        <p class="text-base text-gray-500 text-left">Addresse: ${customer.addresse ? customer.addresse : "--"}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="w-full p-4">
                                ...
                                <div class="mt-4" id="title_future">
                                ...
                                <div class="mt-4" id="title_finished">
                                ...
                                <div class="mt-4" id="title_fenced">
                ...
                populateProjectTable('#table_future', res.projects_future, '#title_future');
                populateProjectTable('#table_in_progress', res.projects_in_progress, '#title_in_progress');
                populateProjectTable('#table_finished', res.projects_finished, '#title_finished');
                populateProjectTable('#table_fenced', res.projects_fenced, '#title_fenced');
        ...
        $.each(projects, function (index, value) {
            bodyProject.append(`<tr>
                ...
                <td class="text-center">
                    <a href="/etp/projets/${value.id_projet}/detail">
...
/* Drawer Fcp */
function showCustomerCfp(idCustomer, route) {
    $.ajax({
        type: "get",
        url: route + idCustomer,
        dataType: "json",
            ...
            if (res) {
                ...
                let principal_referent =
                    ...
                    <li class="pt-3 pb-0 sm:pt-4">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                ${referents[0].photo ? `<img class="w-10 h-10 rounded-full" src="${endpoint}/${bucket}/img/employes/${referents[0].photo}" alt="${referents[0].name ? referents[0].name : ''}">`
                        : `<div class="w-10 h-10 rounded-full text-gray-500 font-bold text-2xl text-center bg-gray-200 relative">
                ...
                referents.forEach((referent, i) => {
                    if (i != 0) {
                        other_referent +=
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    ${referent.photo ? `<img class="w-10 h-10 rounded-full" src="${endpoint}/${bucket}/img/employes/${referent.photo}" alt="${referent.name ? referent.name : ''}">`
                                : `<div class="w-10 h-10 rounded-full text-gray-500 font-bold text-2xl text-center bg-gray-200 relative">
                                                <p class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">${referent.name ? referent.name.charAt(0) : 'I'}</p>
                                            </div>`
                            }
                ...
                let body = $("#drawer_content_detail");
                body.html('');
                body.append(`<div class="offcanvas offcanvas-end !w-[40em] overflow-y-auto" tabindex="-1" id="offcanvasEtp"
                        aria-labelledby="offcanvasEtp">
                        <div class="flex flex-col w-full">
                            <div class="w-full px-4 py-2 inline-flex items-center justify-between bg-gray-100">
                            <p class="text-lg text-gray-500 font-medium">Referents</p>
                            <a data-bs-toggle="offcanvas" href="offcanvasEtp"
                            ...
                            <div class="w-full flex flex-col p-3 relative">
                                <div class="w-full h-40 shadow-md rounded-3xl bg-[url('/img/couvertures/couverture_formation.png')] absolute top-2 left-0 p-4">
                                    <div class="w-full h-full relative">
                                        <div class="w-[116px] h-[77px] bg-white shadow-md rounded-xl absolute flex items-center justify-center top-[5%] left-[12%] p-1">
                                        ${customer.logo ? `<img object-cover class="w-full h-full rounded-xl" src="${endpoint}/${bucket}/img/entreprises/${customer.logo}" alt="${customer.customerName}">` : `<img object-cover class="w-audo h-16 rounded-xl grayscale" src="/img/logo/Logo_mark.svg" alt="${customer.customerName}">`}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full flex flex-col mt-[130px] gap-y-6">
                                ...
                                <h3 class="text-2xl font-bold text-gray-700 text-center">${customer.customerName}</h3>
                                <p class="text-base text-gray-500 text-center">${customer.siteweb ? customer.siteweb : "Site web --"}</p>
                                </div>
                            </div>
                            </div>
...
function viewMiniCV(idFormateur) {
    let drawer_content_detail = $('#drawer_content_detail');
    ...
    $.ajax({
        type: "get",
        url: "/etp/projets/formateur/" + idFormateur + "/mini-cv",
        dataType: "json",
        success: function (res) {
    ...
    let offcanvasId = $('#offcanvasCvForm_' + idFormateur)
...
function showFormation(idModule) {
    ...
    $.ajax({
        type: "get",
        url: "/etp/modules/detail/" + idModule + "/drawer",
        dataType: "json",
        success: function (res) {
            console.log(res);
    ...
    let offcanvasId = $('#offcanvasFormation_' + idModule)
    var bsOffcanvas = new bootstrap.Offcanvas(offcanvasId);
    bsOffcanvas.show();
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.sessions && res.module && res.totalSessionHours) {
                ...
                let totalSessionHours = res.totalSessionHours.sumHourSession;



                let dates = [];
                let organisedSessions = {}; // Utilisation d'un objet pour organiser les sessions par date
                ...
                if (dates != null) {
                    dates.forEach((date) => {
                        ...
                        let _date = moment(date).format('dddd ll');
                ...
                let offcanvasSessionElement = $('#offcanvasSession');
                let offcanvas = new bootstrap.Offcanvas(offcanvasSessionElement);
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <div id="listApprDrawer" class="w-full flex flex-col p-3 relative">
                                ...
                                <div class="inline-flex items-center justify-between w-full">
                                    <p class="text-xl font-medium text-gray-800">Nombres d'apprenants: ${apprenants.length}</p>
                                    <button onclick="editDrawer('apprenants', ${idProjet}, ${idEtp})" class="btn btn-sm btn-outline opacity-70"><i class="fa-solid fa-pen"></i> Modifier</button>
                                </div>
                                <div class="mt-2 px-4">
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res) {
                ...
                let last = document.querySelector("#offcanvasEmployeUnique")
                if (last) {
                    last.remove();
                }
                ...
                let principal_referent =
                    ...
                    <li class="pt-3 pb-0 sm:pt-4">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                ${user.photo ? `<img class="w-16 h-16 rounded-full" src="https://formafusionmg.ams3.cdn.digitaloceanspaces.com/formafusionmg/img/employes/${user.photo}" alt="${user.name ? user.name : ''}">`
                        : `<div class="w-16 h-16 rounded-full text-gray-500 font-bold text-2xl text-center bg-gray-200 relative">
                            ...
                            <div class="flex-1 min-w-0 ms-4 ">
                                ...
                                <p class="text-sm text-gray-500 truncate">
                                <i class="fa-solid fa-phone text-sm"></i>
                                    ${user.customerPhone ? user.customerPhone : 'non renseigné'}                      
                                </p>
                            </div>
                        </div>
                    </li>
                ...
                let offcanvasEtpElement = $('#offcanvasEmployeUnique');
                let offcanvas = new bootstrap.Offcanvas(offcanvasEtpElement);
