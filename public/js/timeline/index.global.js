/*!
FullCalendar Resource Timeline Plugin v6.1.10
    ...
    */
    ...
    class SpreadsheetRow extends internal$1.BaseComponent {
        render() {
            ...
            const resourceFields = internal$2.buildResourceFields(resource); // slightly inefficient. already done up the call stack
        ...
        initColResizing(resizerEl, index) {
            ...
            if (ElementDraggingImpl) {
                ...
                dragging.emitter.on('dragstart', () => {
                    const allCells = internal$1.findElements(internal$1.elementClosest(resizerEl, 'tr'), 'th');
    ...
    */
    ...
    class ResourceTimelineView extends internal$1.BaseComponent {
        ...
        render() {
            ...
            const slatCols = internal$3.buildSlatCols(tDateProfile, slotMinWidth || this.computeFallbackSlotMinWidth(tDateProfile));
    ...
    function processColOptions(options) {
        ...
        const allOrderSpecs = options.resourceOrder || internal$2.DEFAULT_RESOURCE_ORDER;
