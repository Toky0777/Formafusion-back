...
$(document).ready(function () {
  ...
  function openModal() {
    ...
    $("#modalFormateur").show();
    $('#main_form_phone').mask('(+261) 00 00 000 00');
  }
  ...
  function minimizeModal() {
    ...
    $('#modalFormateur').removeClass("hidden");
...
$(document).ready(function () {
  ...
  function openModal() {
    ...
    $("#modalApprenant").show();
    $('#main_appr_phone').mask('(+261) 00 00 000 00');
  }
...
$(document).ready(function () {
  ...
  function openModal() {
    ...
    $("#modalReferent").show();
    $('#main_ref_phone').mask('(+261) 00 00 000 00');
  }
...
$(document).ready(function () {
  ...
  // Vérifier s'il y a une configuration précédente pour le modalEmploye
  var modalEmployeState = sessionStorage.getItem('modalEmployeState');
  if (modalEmployeState === 'minimized') {
    minimizeModal();
  } else if (modalEmployeState === 'normal') {
    openModal();
  }
  ...
  // Fermer le modalEmploye
  $(".closeEmlpoye").click(function () {
  ...
  $("#minimizeBtnEmploye").click(function () {
    if (isMinimized) {
      // Rétablir la taille principale du modalEmploye
      $("#modalEmploye").css({
        "max-height": "none",
        "max-width": "none",
        "overflow": "visible",
...
// Script pour PARTICULIER
$(document).ready(function () {
  var isMinimized = false;

  const reduire = `fa-solid fa-minus`;
  const retablir = `fa-solid fa-up-right-and-down-left-from-center`;
  $('.reduireParticulier').addClass(reduire);

  // Vérifier s'il y a une configuration précédente pour le modalParticulier
  var modalParticulierState = sessionStorage.getItem('modalParticulierState');
  if (modalParticulierState === 'minimized') {
    minimizeModal();
  } else if (modalParticulierState === 'normal') {
    openModal();
  }

  // Ouvrir le modalParticulier
  function openModal() {
    $("#screenParticulier").removeClass(`items-end justify-end fixed bottom-0 right-[280px]`);
    $("#screenParticulier").addClass(`w-screen h-screen flex items-center justify-center mx-auto fixed top-0 right-0 z-50 bg-gray-400/25 backdrop-blur-sm`);
    $("#modalParticulier").show();
  }

  // Ouvrir le modalParticulier
  $("#openModalBtnParticulier").click(function () {
    sessionStorage.setItem('modalParticulierState', 'normal');
    openModal();
  });

  // Fermer le modalParticulier
  $(".closeParticulier").click(function () {
    $("#screenParticulier").removeClass(`w-screen h-screen flex items-center justify-center mx-auto fixed top-0 right-0 z-50 bg-gray-400/25 backdrop-blur-sm`);
    $("#modalParticulier").hide();
    sessionStorage.removeItem('modalParticulierState');
  });

  // Réduire ou rétablir le modalParticulier
  $("#minimizeBtnParticulier").click(function () {
    if (isMinimized) {
      // Rétablir la taille principale du modalParticulier
      $("#modalParticulier").css({
        "max-height": "none",
        "max-width": "none",
        "overflow": "visible",
      });
  ...
  function minimizeModal() {
    ...
    $("#screenParticulier").removeClass(`w-screen h-screen flex items-center justify-center mx-auto fixed top-0 right-0 z-50 bg-gray-400/25 backdrop-blur-sm`);
    $("#screenParticulier").addClass(`items-end justify-end fixed bottom-0 right-[280px]`);
    $('#modalParticulier').removeClass("hidden");
    $('.reduireParticulier').addClass(retablir);
    isMinimized = true;
    sessionStorage.setItem('modalParticulierState', 'minimized');
  }
});
...
// Script pour CLIENT INFORMELLE
$(document).ready(function () {
  var isMinimized = false;

  const reduire = `fa-solid fa-minus`;
  const retablir = `fa-solid fa-up-right-and-down-left-from-center`;
  $('.reduireClientInformelle').addClass(reduire);

  // Vérifier s'il y a une configuration précédente pour le modalClient
  var modalClientInformelleState = sessionStorage.getItem('modalClientInformelleState');
  if (modalClientInformelleState === 'minimized') {
    minimizeModal();
  } else if (modalClientInformelleState === 'normal') {
    openModal();
  }

  // Ouvrir le modalClient
  function openModal() {
    $("#screenClientInformelle").removeClass(`items-end justify-end fixed bottom-0 right-[280px]`);
    $("#screenClientInformelle").addClass(`w-screen h-screen flex items-center justify-center mx-auto fixed top-0 right-0 z-50 bg-gray-400/25 backdrop-blur-sm`);
    $("#modalClientInformelle").show();
  }

  // Ouvrir le modalClient
  $("#openModalBtnClientInformelle").click(function () {
    sessionStorage.setItem('modalClientInformelleState', 'normal');
    openModal();
  });

  // Fermer le modalClient
  $(".closeClientInformelle").click(function () {
    $("#screenClientInformelle").removeClass(`w-screen h-screen flex items-center justify-center mx-auto fixed top-0 right-0 z-50 bg-gray-400/25 backdrop-blur-sm`);
    $("#modalClientInformelle").hide();
    sessionStorage.removeItem('modalClientInformelleState');
  });

  // Réduire ou rétablir le modalClient
  $("#minimizeBtnClientInformelle").click(function () {
    if (isMinimized) {
      // Rétablir la taille principale du modalClient
      $("#modalClientInformelle").css({
        "max-height": "none",
        "max-width": "none",
        "overflow": "visible",
      });
  ...
  function minimizeModal() {
    ...
    $("#screenClientInformelle").removeClass(`w-screen h-screen flex items-center justify-center mx-auto fixed top-0 right-0 z-50 bg-gray-400/25 backdrop-blur-sm`);
    $("#screenClientInformelle").addClass(`items-end justify-end fixed bottom-0 right-[280px]`);
    $('#modalClientInformelle').removeClass("hidden");
    $('.reduireClientInformelle').addClass(retablir);
    isMinimized = true;
    sessionStorage.setItem('modalClientInformelleState', 'minimized');
  }
});