    ...
    success: function (res) {
      ...
      $($('.statut_item_checkbox, .etp_item_checkbox, .type_item_checkbox, .periode_item_checkbox, .module_item_checkbox, .ville_item_checkbox, .mois_item_checkbox')).change(function () {
        ...
        $('.resetClick_statut').click(function () {
          refresh('statut', null, idEtps.toString(), idTypes.toString(), idPeriodes, idModules.toString(), idVilles.toString(), idMois.toString());
        });
        ...
        $('.resetClick_entreprise').click(function () {
          refresh('entreprise', idStatus.toString(), null, idTypes.toString(), idPeriodes, idModules.toString(), idVilles.toString(), idMois.toString());
        });
        ...
        $('.resetClick_type').click(function () {
          refresh('type', idStatus.toString(), idEtps.toString(), null, idPeriodes, idModules.toString(), idVilles.toString(), idMois.toString());
        });
        ...
        $('.iconClose-periode').click(function () {
          getDropdownItem();
          refresh('periode', idStatus.toString(), idEtps.toString(), idTypes.toString(), null, idModules.toString(), idVilles.toString(), idMois.toString());
          $('.selectedFilter_periode').addClass('hidden');
          $('.unselectedFilter_periode').removeClass('hidden');
        });
        ...
        $('.resetClick_cours').click(function () {
          refresh('cours', idStatus.toString(), idEtps.toString(), idTypes.toString(), idPeriodes, null, idVilles.toString(), idMois.toString());
        });
        ...
        $('.resetClick_ville').click(function () {
          refresh('ville', idStatus.toString(), idEtps.toString(), idTypes.toString(), idPeriodes, idModules.toString(), null, idMois.toString());
        });
