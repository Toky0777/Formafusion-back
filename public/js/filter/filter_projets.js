function getDropdownItem() {
  ...
  $.ajax({
    type: "get",
    url: "/cfp/projets/filter/getDropdownItem",
    dataType: "json",
    success: function (res) {
                            ...
                            <div class="grid grid-cols-subgrid col-span-5 truncate" title="`+ v.project_status + `">
                              <span class="inline-flex items-center gap-2 px-2">
                                <input 
                                  ...
                                  class="radio statut_item_checkbox">
      ...
      periodes.append(`<li>
                        <label class="p-1 label cursor-pointer grid grid-cols-6">
                          <div class="grid grid-cols-subgrid col-span-5 truncate">
                            <span class="inline-flex items-center gap-2 px-2">
                              <input 
                                id="p_vp_3"
                                value=""
                            ...
                            <div class="grid grid-cols-subgrid col-span-5 truncate" title="`+ v.paiement + `">
                              <span class="inline-flex items-center gap-2 px-2">
                                <input 
                                  ...
                                  type="checkbox"
                                  value="`+ v.idPaiement + `"
                                  class="checkbox financement_item_checkbox">
                                <p class="text-gray-500 label-text">`+ v.paiement + `</p>
                              </span>
                            </div>
          ...
          formateurs.append(`<li class="formateur_item_` + v.idFormateur + `">
                          <label class="p-1 label cursor-pointer grid grid-cols-6">
                            <div class="grid grid-cols-subgrid col-span-5 truncate" title="`+ v.form_name + ` ` + v.form_firstname + `">
                              <span class="inline-flex items-center gap-2 px-2">
                                <input 
                                  id="formateur_${v.idFormateur}"
                                  type="checkbox"
                                  value="`+ v.idFormateur + `"
                                  class="checkbox formateur_item_checkbox">
                                <p class="text-gray-500 label-text">`+ v.form_name + ` ` + v.form_firstname + `</p>
                              </span>
                            </div>
      ...
      $($('.statut_item_checkbox, .etp_item_checkbox, .type_item_checkbox, .periode_item_checkbox, .module_item_checkbox, .ville_item_checkbox, .financement_item_checkbox, .formateur_item_checkbox, .mois_item_checkbox')).change(function () {
        var idStatus = [];
        var idEtps = [];
        var idTypes = [];
        var idPeriodes;
        ...
        $('.resetClick_statut').click(function () {
          refresh('statut', null, idEtps.toString(), idTypes.toString(), idPeriodes, idModules.toString(), idVilles.toString(), idFinancements.toString(), idFormateurs.toString(), idMois.toString());
        });
        ...
        $('.resetClick_type').click(function () {
          refresh('type', idStatus.toString(), idEtps.toString(), null, idPeriodes, idModules.toString(), idVilles.toString(), idFinancements.toString(), idFormateurs.toString(), idMois.toString());
        });
        ...
        $('.iconClose-periode').click(function () {
          getDropdownItem();
          refresh('periode', idStatus.toString(), idEtps.toString(), idTypes.toString(), null, idModules.toString(), idVilles.toString(), idFinancements.toString(), idFormateurs.toString(), idMois.toString());
          $('.selectedFilter_periode').addClass('hidden');
          $('.unselectedFilter_periode').removeClass('hidden');
        });
        ...
        $('.resetClick_cours').click(function () {
          refresh('cours', idStatus.toString(), idEtps.toString(), idTypes.toString(), idPeriodes, null, idVilles.toString(), idFinancements.toString(), idFormateurs.toString(), idMois.toString());
        });
        ...
        $('.resetClick_ville').click(function () {
          refresh('ville', idStatus.toString(), idEtps.toString(), idTypes.toString(), idPeriodes, idModules.toString(), null, idFinancements.toString(), idFormateurs.toString(), idMois.toString());
        });
        ...
        $('.resetClick_financement').click(function () {
          refresh('financement', idStatus.toString(), idEtps.toString(), idTypes.toString(), idPeriodes, idModules.toString(), idVilles.toString(), null, idFormateurs.toString(), idMois.toString());
        });
        ...
        $('.resetClick_formateur').click(function () {
          refresh('formateur', idStatus.toString(), idEtps.toString(), idTypes.toString(), idPeriodes, idModules.toString(), idVilles.toString(), idFinancements.toString(), null, idMois.toString());
        });
        ...
        $('.resetClick_mois').click(function () {
          refresh('mois', idStatus.toString(), idEtps.toString(), idTypes.toString(), idPeriodes, idModules.toString(), idVilles.toString(), idFinancements.toString(), idFormateurs.toString(), null);
        });
        ...
        filterItems(idStatus.toString(), idEtps.toString(), idTypes.toString(), idPeriodes, idModules.toString(), idVilles.toString(), idFinancements.toString(), idFormateurs.toString(), idMois.toString());
      });
    }
  });
}

function filterItems(idStatut, idEtp, idType, idPeriode, idModule, idVille, idFinancement, idFormateur, idMois) {
  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      $($('.statut_item_checkbox, .etp_item_checkbox, .type_item_checkbox, .periode_item_checkbox, .module_item_checkbox, .ville_item_checkbox, .financement_item_checkbox, .formateur_item_checkbox,.mois_item_checkbox')).change(function () {
        ...
        filterItem(idStatus.toString(), idEtps.toString(), idTypes.toString(), idPeriodes, idModules.toString(), idVilles.toString(), idFinancements.toString(), idFormateurs.toString(), idMois.toString());
      });
...
function filterItem(idStatut, idEtp, idType, idPeriode, idModule, idVille, idFinancement, idFormateur, idMois) {
  var showResult = $('.showResult');

  $.ajax({
    type: "get",
    url: "/cfp/projets/filter/item",
    data: {
      idStatut: idStatut,
      idEtp: idEtp,
      idType: idType,
...
function refresh(itemClicked, idStatut, idEtp, idType, idPeriode, idModule, idVille, idFinancement, idFormateur, idMois) {
  switch (itemClicked) {
    case "statut":
      $('.statut_item_checkbox').prop('checked', false);
      $('.countSelected_statut').text("");
      filterItem(idStatut, idEtp, idType, idPeriode, idModule, idVille, idFinancement, idFormateur, idMois)
      break;
    case "entreprise":
