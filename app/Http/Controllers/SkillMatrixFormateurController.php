...
class SkillMatrixFormateurController extends Controller
{
    ...
    public function index()
    {
        $projects = DB::table('v_projet_form')
            ->select('idProjet', 'idModule', 'module_name', 'etp_logo', 'etp_name', 'module_description', 'module_image', 'dateDebut as start_date', 'dateFin as end_date', 'project_status')
    ...
    {
        $project = DB::table('v_projet_form')
            ->select('idProjet', 'idModule', 'module_name', 'etp_logo', 'etp_name', 'module_description', 'module_image', 'dateDebut as start_date', 'dateFin as end_date', 'project_status', 'c.customerName as cfp_name')
            ->join('customers as c', 'v_projet_form.idCfp', 'c.idCustomer')
            ->where('idFormateur', auth()->user()->id)
