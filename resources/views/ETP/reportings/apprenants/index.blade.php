...
@section('content')
    <div class="flex flex-col w-full mx-auto xl:p-0 gap-y-4 xl:container align-center">
        <div class="flex items-center justify-between w-full">
            <form action="{{ route('reporting.filter.formationEtp') }}" method="post">
                @csrf
                <label class="input input-bordered w-[28rem] flex items-center gap-2">
                ...
                <table class="table align-middle table-striped caption-top table-hover">
                    <thead class="table-light">
                        <tr class="!text-2xl font-medium text-gray-800">
                            ...
                            <th scope="col" class="text-right">Présence(Taux)</th>
                        </tr>
                    </thead>
                    <tbody id="showResult">
                        @foreach ($all_learner as $item)
                            <tr class="text-lg text-gray-600">
                                ...
                                <td class="text-right">{{ $item->taux_de_presence }} %</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
